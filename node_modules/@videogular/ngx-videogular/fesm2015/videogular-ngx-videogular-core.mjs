...
/** @nocollapse */ /** @nocollapse */ VgPlayerComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: VgPlayerComponent, selectors: [["vg-player"]], contentQueries: function VgPlayerComponent_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
    ...
    }, hostVars: 8, hostBindings: function VgPlayerComponent_HostBindings(rf, ctx) {
        if (rf & 2) {
    ...
    }, outputs: { onPlayerReady: "onPlayerReady", onMediaReady: "onMediaReady" }, features: [i0.ɵɵProvidersFeature([VgApiService, VgFullscreenApiService, VgControlsHiddenService])], ngContentSelectors: _c0, decls: 1, vars: 0, template: function VgPlayerComponent_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵprojectionDef();
            i0.ɵɵprojection(0);
        }
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(VgCoreModule, { declarations: [VgCuePointsDirective,
