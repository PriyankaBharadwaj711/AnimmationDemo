(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng-audio-recorder', ['exports', '@angular/core'], factory) :
    (global = global || self, factory(global['ng-audio-recorder'] = {}, global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var NgAudioRecorderService = /** @class */ (function () {
        function NgAudioRecorderService() {
            var _this = this;
            this.chunks = [];
            this.recorderEnded = new core.EventEmitter();
            this.recorderError = new core.EventEmitter();
            // tslint:disable-next-line
            this._recorderState = exports.RecorderState.INITIALIZING;
        ...
        NgAudioRecorderService.prototype.startRecording = function () {
            var _this = this;
            if (this._recorderState === exports.RecorderState.RECORDING) {
                this.recorderError.emit(exports.ErrorCase.ALREADY_RECORDING);
            }
            if (this._recorderState === exports.RecorderState.PAUSED) {
                this.resume();
                return;
            }
            this._recorderState = exports.RecorderState.INITIALIZING;
            NgAudioRecorderService_1.guc().then(function (mediaStream) {
                ...
                _this._recorderState = exports.RecorderState.INITIALIZED;
                _this.addListeners();
                _this.recorder.start();
                _this._recorderState = exports.RecorderState.RECORDING;
            });
        };
        NgAudioRecorderService.prototype.pause = function () {
            if (this._recorderState === exports.RecorderState.RECORDING) {
                this.recorder.pause();
                this._recorderState = exports.RecorderState.PAUSED;
            }
        };
        NgAudioRecorderService.prototype.resume = function () {
            if (this._recorderState === exports.RecorderState.PAUSED) {
                this._recorderState = exports.RecorderState.RECORDING;
                this.recorder.resume();
            }
        };
        NgAudioRecorderService.prototype.stopRecording = function (outputFormat) {
            var _this = this;
            this._recorderState = exports.RecorderState.STOPPING;
            return new Promise(function (resolve, reject) {
                _this.recorderEnded.subscribe(function (blob) {
                    _this._recorderState = exports.RecorderState.STOPPED;
                    if (outputFormat === exports.OutputFormat.WEBM_BLOB) {
                        resolve(blob);
                    }
                    if (outputFormat === exports.OutputFormat.WEBM_BLOB_URL) {
                        var audioURL = URL.createObjectURL(blob);
                        resolve(audioURL);
                    }
                }, function (_) {
                    _this.recorderError.emit(exports.ErrorCase.RECORDER_TIMEOUT);
                    reject(exports.ErrorCase.RECORDER_TIMEOUT);
                });
                _this.recorder.stop();
            }).catch(function () {
                _this.recorderError.emit(exports.ErrorCase.USER_CONSENT_FAILED);
            });
        };
    ...
    })(exports.ErrorCase || (exports.ErrorCase = {}));
    ...
    })(exports.RecorderState || (exports.RecorderState = {}));
    ...
    exports.NgAudioRecorderModule = NgAudioRecorderModule;
    exports.NgAudioRecorderService = NgAudioRecorderService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ng-audio-recorder.umd.js.map
