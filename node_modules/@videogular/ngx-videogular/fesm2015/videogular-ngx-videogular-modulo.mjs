...
/** @nocollapse */ /** @nocollapse */ VgModuloComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: VgModuloComponent, selectors: [["vg-modulo"]], viewQuery: function VgModuloComponent_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, inputs: { moduloConfig: "moduloConfig", audioElement: "audioElement" }, decls: 2, vars: 0, consts: [["waveCanvas", ""]], template: function VgModuloComponent_Template(rf, ctx) {
        if (rf & 1) {
